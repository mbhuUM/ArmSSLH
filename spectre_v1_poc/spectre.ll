...
19:                                               ; preds = %16
  ...
  %21 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef @.str, i32 noundef 2048, i32 noundef 4, i32 noundef 512) #5
...
33:                                               ; preds = %22
  ...
  %39 = add i64 %36, %38
  %40 = add i64 %39, 2
  %41 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %34, ptr noundef @.str.1, i64 noundef %40) #5
...
50:                                               ; preds = %46
  ...
  %52 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %51, ptr noundef @.str.2, i64 noundef 8) #5
...
83:                                               ; preds = %79
  ...
  %85 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %84, ptr noundef @.str.3, i64 noundef 40) #5
...
attributes #3 = { nounwind "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+complxnum,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+jsconv,+lse,+neon,+pauth,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
!9 = distinct !{!9, !8}
!10 = distinct !{!10, !8}
!11 = !{i64 2148444525, i64 2148444534}
!12 = distinct !{!12, !8}
!13 = !{i64 2148442999, i64 2148443008}
!14 = !{i64 2148443067, i64 2148443076}
!15 = !{i64 2148443115}
!16 = !{i64 2148443198, i64 2148443207}
!17 = !{i64 2148443264, i64 2148443273}
!18 = distinct !{!18, !8}
!19 = distinct !{!19, !8}
!20 = distinct !{!20, !8}
!21 = distinct !{!21, !8}

...
17:                                               ; preds = %14
  %18 = call i64 @find_threshold()
  %19 = trunc i64 %18 to i32
  call void @evset_init(ptr noundef @traverse_list_skylake, i32 noundef 32, i32 noundef 16384, i32 noundef 20971520, i32 noundef %19)
  br label %20
...
21:                                               ; preds = %52, %20
  ...
  %23 = load i32, ptr @evsets_count, align 4
  %24 = sext i32 %23 to i64
...
26:                                               ; preds = %21
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %27) #8, !srcloc !28
  %28 = load ptr, ptr %6, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %28) #8, !srcloc !29
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !30
  %29 = load ptr, ptr @traverser, align 8
  %30 = load ptr, ptr @eviction_sets, align 8
  %31 = load i64, ptr %8, align 8
  %32 = getelementptr inbounds ptr, ptr %30, i64 %31
  %33 = load ptr, ptr %32, align 8
  call void %29(ptr noundef %33)
  %34 = load ptr, ptr @traverser, align 8
  %35 = load ptr, ptr @eviction_sets, align 8
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %41) #8, !srcloc !20
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !21
  ...
  %45 = sub i64 %43, %44
  %46 = load i64, ptr @threshold, align 8
...
55:                                               ; preds = %21
  %56 = load i32, ptr @evsets_count, align 4
  %57 = add nsw i32 %56, 1
  store i32 %57, ptr @evsets_count, align 4
  %58 = sext i32 %56 to i64
  store i64 %58, ptr %9, align 8
  %59 = load i32, ptr @evsets_count, align 4
  %60 = srem i32 %59, 8
  %61 = icmp eq i32 %60, 1
  br i1 %61, label %62, label %75

62:                                               ; preds = %55
  %63 = load ptr, ptr @eviction_sets, align 8
  %64 = load i32, ptr @evsets_count, align 4
  %65 = add nsw i32 %64, 8
  %66 = sext i32 %65 to i64
  %67 = mul i64 8, %66
  %68 = call ptr @realloc(ptr noundef %63, i64 noundef %67) #9
  store ptr %68, ptr @eviction_sets, align 8
  %69 = load ptr, ptr @eviction_sets_pages, align 8
  %70 = load i32, ptr @evsets_count, align 4
  %71 = add nsw i32 %70, 8
  %72 = sext i32 %71 to i64
  %73 = mul i64 8, %72
  %74 = call ptr @realloc(ptr noundef %69, i64 noundef %73) #9
  store ptr %74, ptr @eviction_sets_pages, align 8
  br label %75

75:                                               ; preds = %62, %55
  %76 = load ptr, ptr %6, align 8
  call void @evset_find(ptr noundef %76)
  call void @timer_stop()
...
!16 = distinct !{!16, !7}
!17 = !{i64 2148490951}
!18 = !{i64 2148489762, i64 2148489771}
!19 = !{i64 2148489830, i64 2148489839}
!20 = !{i64 2148489878}
!21 = !{i64 2148489961, i64 2148489970}
!22 = !{i64 2148490027, i64 2148490036}
!23 = distinct !{!23, !7}
!24 = !{i64 2148491107}
!25 = distinct !{!25, !7}
!26 = distinct !{!26, !7}
...
!28 = !{i64 2148491236}
!29 = !{i64 2148491316}
!30 = !{i64 2148491396, i64 2148491405}
!31 = distinct !{!31, !7}
!32 = !{i64 2148490435}
!33 = !{i64 2148490514}
!34 = !{i64 2148490599}
...
!47 = !{i64 2148491767}
!48 = !{i64 2148491849}
!49 = !{i64 2148491931, i64 2148491940}
!50 = distinct !{!50, !7}
